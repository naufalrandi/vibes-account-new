...
export const AXIA_TEAM: readonly AxiaTeamMember[] = [
  ...
  { odId: "axia3", username: "support.lead", email: "support@axia.io", fullName: "Nicholas Joseph Fury",
    ...
    status: "Active", superAdmin: false, provisioned: true, units: [], createdAt: may(1), lastLogin: null },
  { odId: "axia4", username: "pernille.admin", email: "pernille@axia.io", fullName: "Carol Susan Jane Danvers",
  ...
  { odId: "axia5", username: "andres.support", email: "andres@axia.io", fullName: "Steven Grant Rogers",
    roleGroup: "Technical Support", permissionMode: null, permissions: ["ticket"],
  ...
  { odId: "axia6", username: "samantha.billing", email: "samantha@axia.io", fullName: "Jean Elaine Grey",
    roleGroup: "Billing Manager", permissionMode: null, permissions: ["billing"],
  ...
  { odId: "axia9", username: "ororo.munroe", email: "ororo.munroe@axia.io", fullName: "Ororo Munroe",
    ...
    status: "Active", superAdmin: false, provisioned: false, units: [], createdAt: may(11), lastLogin: null },
  { odId: "axia10", username: "bruce.banner", email: "bruce.banner@axia.io", fullName: "Robert Bruce Banner",
    roleGroup: "", permissionMode: null, permissions: [],
  ...
  { odId: "axia12", username: "bobby.drake", email: "bobby.drake@axia.io", fullName: "Robert Louis Drake",
    roleGroup: "", permissionMode: null, permissions: [],
