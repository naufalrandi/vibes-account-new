...
import { signatoryRoutes } from "./modules/organizations/signatory.routes";
import { registrationRoutes } from "./modules/organizations/registration.routes";
import { tenantRoutes } from "./modules/organizations/tenant.routes";
...
import { siteRequestRoutes } from "./modules/sites/siteRequest.routes";
import { agreementTemplateRoutes } from "./modules/agreements/agreementTemplate.routes";
import { partnerRoutes } from "./modules/partners/partner.routes";
import { billingRoutes } from "./modules/billing/billing.routes";
import { requirementRoutes } from "./modules/frameworks/requirement.routes";
import { elementRoutes } from "./modules/frameworks/element.routes";
import { criterionRoutes } from "./modules/frameworks/criterion.routes";
import { xrefRoutes } from "./modules/frameworks/xref.routes";
import { frameworkGroupRoutes } from "./modules/frameworks/frameworkGroup.routes";
import { assessmentRoutes } from "./modules/assessment/assessment.routes";
import { frameworkAssignmentRoutes } from "./modules/frameworks/frameworkAssignment.routes";
import { kbRoutes } from "./modules/support/kb.routes";
...
export function createApp() {
  ...
  app.use("/v1/partnership-agreements", authenticate, tenantScope, agreementTemplateRoutes);
  ...
  app.use("/v1/criteria", authenticate, tenantScope, criterionRoutes);
