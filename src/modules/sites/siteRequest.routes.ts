...
siteRequestRoutes.post("/", requireAction(ACTIONS.SITE_REQUEST_SUBMIT), c.create);
...
siteRequestRoutes.post("/:id/provision", requireAction(ACTIONS.SITE_PROVISION), c.provision);
